...
public class EmployeeController {
	...
	// Dynamic sorting based on any entity feild
	@GetMapping("/getAll")
	public ResponseEntity<List<Employee>> getAllEmployee(@RequestParam(defaultValue = "id") String sortBy)
	{
		List<Employee> employee2 = employeeServiceInterface.findBy(Sort.by(Sort.Direction.ASC,sortBy));
